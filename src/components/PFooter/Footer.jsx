...
const PFooter = () => {
    ...
    () => {
      ...
      const createParticles = () => {
        ...
        imagePaths.forEach((path) => {
          ...
          particle.src = path;
          particle.classList.add("pc-explosion-particle-img");
  ...
  return (
    <footer className="pc-footer" ref={footerRef}>
      <div className="pc-footer-container">
        <div className="pc-footer-header-content">
        ...
        <div className="pc-footer-byline">
          <div className="pc-footer-time">
            <p>
              Toronto, ON <span>{torontoTime}</span>
            </p>
          </div>

          <div className="pc-footer-author">
      ...
      <div className="pc-explosion-container" ref={explosionContainerRef}></div>
    </footer>
  );
};
