...
import {
  getCommand,
  getAllCommands,
} from "@/components/os/utils/terminal/registry";
import { TerminalCommand } from "@/components/os/utils/terminal/types";
import { getColorShades } from "@/components/os/utils/colors";
