...
import { getAllApps, getAppsByCategory, type AppMetadata } from '@/components/os/config/appRegistry';
...
import { useAppInstaller } from '@/components/os/hooks/useAppInstaller';
