...
import { usePhotos, Photo, PhotosProvider } from '@/components/os/components/PhotosContext';
...
import { Lightbox } from '@/components/os/components/ui/Lightbox';
import { EmptyState } from '@/components/os/components/ui/empty-state';
import { Button } from '@/components/os/components/ui/button';
import { getSafeImageUrl } from '@/components/os/utils/urlUtils';
