...
import { MessagesService } from '@/components/os/services/MessagesService';
import { getStorageStats, formatBytes, getWindowKey, STORAGE_KEYS } from '@/components/os/utils/memory';
import { safeParseLocal } from '@/components/os/utils/safeStorage';
import { calculateTotalRamUsage, RamUsageReport } from '@/components/os/utils/resourceMonitor';
import { useFileSystem, FileNode } from '@/components/os/components/FileSystemContext';
                        ...
                        <div className="flex-1 overflow-hidden flex gap-4">
                            ...
                            <div className="flex-1 flex flex-col overflow-hidden border border-white/10 rounded-lg bg-black/20">
                                <div className="p-2 border-b border-white/10 bg-white/5 flex items-center gap-2">
                                    ...
                                    <span className="text-xs text-white/30 ml-2 font-mono">root@bec-vortex-os:~</span>
                                </div>
