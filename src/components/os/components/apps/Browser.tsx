...
import { getWebsiteByDomain } from '@/components/os/components/websites/registry';
import type { HistoryEntry } from '@/components/os/components/websites/types';
...
import { parseHostsFile, resolveHost } from '@/components/os/utils/network';
import { incrementSessionDataUsage } from '@/components/os/utils/memory';
