...
import { Checkbox } from '@/components/os/components/ui/checkbox';
import { AppTemplate } from '@/components/os/components/apps/AppTemplate';
import { Accordion, AccordionItem, AccordionTrigger, AccordionContent } from '@/components/os/components/ui/accordion';
import { softReset, hardReset, getStorageStats, formatBytes } from '@/components/os/utils/memory';
import { getComplementaryColor } from '@/components/os/utils/colors';
import { cn } from '@/components/os/components/ui/utils';
import { GlassButton } from '@/components/os/components/ui/GlassButton';
import { GlassInput } from '@/components/os/components/ui/GlassInput';
import { EmptyState } from '@/components/os/components/ui/empty-state';
import { useSessionStorage } from '@/components/os/hooks/useSessionStorage';
import { NetworkSettings } from '@/components/os/components/NetworkSettings';
import { DisplaySettings } from '@/components/os/components/DisplaySettings';
import {
  Select,
  SelectContent,
  SelectItem,
  ...
  const content = ({ width }: { width: number }) => {
    ...
    return (
      <div className={cn("max-w-3xl", isNarrow ? "p-4" : "p-8")}>
        ...
        {activeSection === 'about' && (
          <div>
            <h2 className="text-2xl text-white mb-6">{t('settings.sections.about')} {pkgMeta.build.productName}</h2>
            {/* System Info */}
            <div className="bg-black/20 rounded-xl p-6 mb-6 border border-white/5">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center gap-4 flex-wrap">
                  ...
                  <span className="text-white font-mono text-sm">{pkgMeta.version}</span>
                </div>
                {/* Dynamic Build Info */}
                <div className="flex justify-between items-center gap-4 flex-wrap">
