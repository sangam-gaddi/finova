...
import { useFullscreen } from '@/components/os/hooks/useFullscreen';
import { CreditsDrawer } from '@/components/os/components/Credits/CreditsDrawer';
...
import { AudioApplet } from '@/components/os/components/AudioApplet';
import { NotificationsApplet } from '@/components/os/components/NotificationsApplet';
import { BatteryApplet } from '@/components/os/components/BatteryApplet';
import { MemoryApplet } from '@/components/os/components/MemoryApplet';
import { InternetApplet } from '@/components/os/components/InternetApplet';
import { hardReset, clearSession } from '@/components/os/utils/memory';
import {
  Menubar,
  MenubarMenu,
  MenubarTrigger,
  ...
  MenubarSeparator,
  MenubarShortcut,
} from '@/components/os/components/ui/menubar';
import { Badge } from '@/components/os/components/ui/badge';
import { Tooltip, TooltipContent, TooltipTrigger } from '@/components/os/components/ui/tooltip';

import { getApp } from '@/components/os/config/appRegistry';
          ...
          <MenubarMenu>
            ...
            >
              ...
              <Tooltip>
                ...
                <TooltipContent side="right" sideOffset={10}>
                  <p><b>{t('menubar.system.warning')}:</b> {t('menubar.system.panicWarningBody', { productName: pkgMeta.build.productName })}</p>
                </TooltipContent>
              </Tooltip>
            </MenubarContent>
          </MenubarMenu>
