...
import { SettingsModal } from '@/components/os/components/Game/SettingsModal';
import { CreditsModal } from '@/components/os/components/Game/CreditsModal';
import { useI18n } from '@/components/os/i18n/index';
import { useFileSystem } from '@/components/os/components/FileSystemContext';
import { DevStatusWindow } from '@/components/os/components/Game/DevStatusWindow';
