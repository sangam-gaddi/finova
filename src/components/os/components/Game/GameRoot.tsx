...
import { IntroSequence } from '@/components/os/components/Game/IntroSequence';
import { MainMenu } from '@/components/os/components/Game/MainMenu';
import { BootSequence } from '@/components/os/components/Game/BootSequence';
import { useFileSystem } from '@/components/os/components/FileSystemContext';
import { useAppContext, SystemConfig } from '@/components/os/components/AppContext';
import { PERSISTENT_CONFIG_KEYS } from '@/components/os/config/systemConfig';

import { STORAGE_KEYS } from '@/components/os/utils/memory';
import { Onboarding } from "@/components/os/components/Game/Onboarding";

import { StorageIndicator } from '@/components/os/components/ui/StorageIndicator';
