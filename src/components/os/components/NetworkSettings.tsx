...
import { CustomSwitch } from '@/components/os/components/ui/custom-switch';
...
import {
  ...
  SelectTrigger,
  SelectValue,
} from "@/components/os/components/ui/select";
import { useI18n } from '@/components/os/i18n';
import { validateNetworkConfig } from '@/components/os/utils/networkValidation';
import { useNetworkSimulation, Network } from '@/components/os/hooks/useNetworkSimulation';
import { getSessionDataUsage, STORAGE_EVENT, StorageOperation } from '@/components/os/utils/memory';
