...
import { LoginScreen } from '@/components/os/components/LoginScreen';
import { AppProvider, useAppContext } from '@/components/os/components/AppContext';
import { FileSystemProvider, useFileSystem } from '@/components/os/components/FileSystemContext';
import { GameRoot } from '@/components/os/components/Game/GameRoot';
import { MusicProvider } from '@/components/os/components/MusicContext';
import { PhotosProvider } from '@/components/os/components/PhotosContext';
import { FinovaProvider } from '@/components/os/components/apps/FinovaContext';

// Lazy load the Heavy OS component
// This ensures we don't load Desktop/Apps/Assets until we actually start the game
const OS = lazy(() => import('@/components/os/components/OS'));

import { ErrorBoundary } from '@/components/os/components/ErrorBoundary';
