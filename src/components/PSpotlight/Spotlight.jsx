...
const Spotlight = () => {
  ...
  useGSAP(
    () => {
      ...
      const initSpotlight = () => {
        new SplitType(".pc-marquee-text-item h1", { types: "chars" });

        document
          .querySelectorAll(".pc-marquee-container")
          .forEach((container, index) => {
            const marquee = container.querySelector(".pc-marquee");
  ...
  return (
    <section className="pc-spotlight" ref={spotlightRef}>
      <div className="pc-marquees">
        <div className="pc-marquee-container" id="pc-marquee-1">
          <div className="pc-marquee">
            <div className="pc-marquee-img-item">
              <img src="/spotlight/spotlight-1.jpg" alt="" />
            </div>
            <div className="pc-marquee-img-item pc-marquee-text-item">
              <h1>Hyperreal</h1>
            </div>
            <div className="pc-marquee-img-item">
        ...
        <div className="pc-marquee-container" id="pc-marquee-2">
          <div className="pc-marquee">
            <div className="pc-marquee-img-item">
        ...
        <div className="pc-marquee-container" id="pc-marquee-3">
          <div className="pc-marquee">
            <div className="pc-marquee-img-item">
        ...
        <div className="pc-marquee-container" id="pc-marquee-4">
          <div className="pc-marquee">
            <div className="pc-marquee-img-item">
