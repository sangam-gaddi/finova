...
export default function TeamCards() {
  ...
  return (
    <>
      ...
      <section className="pc-sticky team-desktop" ref={stickyRef}>
        <div className="pc-sticky-header" ref={headerRef}>
          <h1>Minds at Work</h1>
        </div>
        {teamMembers.map((m, idx) => (
          ...
          >
            ...
            <div className="pc-card-content">
              ...
              <div className="pc-card-description">
                <p>{m.description}</p>
              </div>
            </div>
          </div>
      ...
      <section className="pc-team-mobile">
        <div className="pc-mobile-header">
          <h1>Minds at Work</h1>
        </div>
        {teamMembers.map((m) => (
          <div className="pc-card" id={m.id} key={`m-${m.id}`}>
            <div className="pc-card-img">
              <img src={m.img} alt={m.alt} />
            </div>
            <div className="pc-card-content">
